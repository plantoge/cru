...
class EmailVerificationTest extends TestCase
{
    ...
    public function test_registrasi_kirim_notifikasi_verify_email(): void
    {
        Notification::fake();
    ...
    public function test_user_belum_verified_diarahkan_ke_notice(): void
    {
    ...
    public function test_klik_link_signed_menandai_verified_dan_bisa_akses(): void
    {
        $user = User::factory()->unverified()->create();
        $user->assignRole('peneliti');
    ...
    public function test_user_verified_tidak_diarahkan_ke_notice(): void
    {
